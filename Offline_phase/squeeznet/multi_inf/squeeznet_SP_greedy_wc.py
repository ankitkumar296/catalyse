...
def main(para=1) -> None:
    ...
    main_et_file=f'./readings/greedy_wc/inst_set_{NO_OF_INFERENCE}_delay/main_ET_greedy.csv'
    ...
    for inst in range(NO_OF_INFERENCE):
        ...
        updators[inst]=update_class(mode=44,read_file_name=f'./readings/greedy_wc/inst_set_{NO_OF_INFERENCE}_delay/inf{inst}_greedy.csv')
