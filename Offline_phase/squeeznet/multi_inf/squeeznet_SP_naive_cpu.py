...
def main(para=1) -> None:
    ...
    with open('./squeeznet_naive_cpuProfiling_mappings.pkl', 'rb') as file:
    ...
    for inst in range(NO_OF_INFERENCE):
        ...
        updators[inst]=update_class(mode=44,read_file_name=f'./readings/naive_cpu/inst_set_{NO_OF_INFERENCE}_delay/inf{inst}_greedy.csv')
