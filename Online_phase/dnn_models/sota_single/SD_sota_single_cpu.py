...
def main() -> None:
    ...
    NO_OF_CPU=24
    NO_OF_LAYERS=18
    main_et_file='./readings/sota/lbl_single/main_ET.csv'
    ...
    up1=update_class(mode=18,read_file_name='./readings/sota/lbl_single/inf1.csv')
    up2=update_class(mode=18,read_file_name='./readings/sota/lbl_single/inf2.csv')
    ...
    # cpu_log.remove(0)
    pool.apply_async(child, (1,cpu_log,18,inp1),callback=up1.updater)
    # cpu , cpu_log= get_best_cpu(up2,cpu_log)
    # cpu_log.remove(1)
    pool.apply_async(child, (5,cpu_log,18,inp2),callback=up2.updater)
